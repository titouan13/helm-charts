...
* The default scrape configs have been updated to take new and old labels into consideration. Default pipeline stages has changed from docker to cri (it can be a breaking change).
